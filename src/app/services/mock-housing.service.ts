...
export class MockHousingService {
  private mockListings: HousingListing[] = [
    ...
    },
    {
      ...
      address: '321 High Rise Blvd, Midtown',
      zipCode: '10001',
      price: 2800,
      bedrooms: 1,
      bathrooms: 1,
      ...
      description: 'Luxury apartment with stunning city views. High-end finishes and premium amenities.',
      datePosted: new Date('2024-01-22'),
      isFeatured: true,
      contactInfo: 'luxury@cityview.com',
      ownerId: 'owner4',
      location: 'Midtown',
      createdAt: new Date('2024-01-22'),
      landlord: {
        name: 'City View Luxury',
        phone: '(555) 111-2222',
        email: 'luxury@cityview.com',
        rating: 4.9
      }
    },
    {
      id: '5',
      title: 'Affordable 2BR in Quiet Neighborhood',
      address: '654 Pine Street, Residential',
      zipCode: '10004',
      price: 1800,
      bedrooms: 2,
      bathrooms: 1,
      ...
      description: 'Great value apartment in a quiet, safe neighborhood. Perfect for young professionals.',
      datePosted: new Date('2024-01-19'),
      isFeatured: false,
      contactInfo: 'info@pinestreet.com',
      ownerId: 'owner5',
      location: 'Residential',
      createdAt: new Date('2024-01-19'),
      landlord: {
        name: 'Pine Street Rentals',
        phone: '(555) 333-4444',
        email: 'info@pinestreet.com',
        rating: 4.3
      }
    }
  ];
  ...
  getFeaturedListings(): Observable<HousingListing[]> {
    console.log('🏠 Getting mock featured listings');
    
    return of(this.mockListings.filter(listing => listing.isFeatured)).pipe(
      delay(800) // Simulate network delay
    );
  }

  searchHousing(filters: any): Observable<HousingListing[]> {
    console.log('🔍 Mock housing search with filters:', filters);
    ...
    return of(this.mockListings).pipe(
      ...
      map(listings => {
        ...
        console.log(`✅ Mock search returned ${filteredListings.length} results`);
  ...
  getListingById(id: string): Observable<HousingListing | null> {
    console.log('🏠 Getting mock listing by ID:', id);
    
    const listing = this.mockListings.find(l => l.id === id);
    return of(listing || null).pipe(delay(500));
  }
}